...
export default function ModalTabWorkExpiredUrgent() {
  ...
  const fetchData = async () => {
    const res = isAuthorized
      ? await activityService.getAllWorksExpiredUrgent(dataFilters)
      : await activityService.getAllWorksExpiredUrgentByUser(dataFilters);
